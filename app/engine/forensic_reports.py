...
# ReasoningRiskClassifier now lives in reasoning_profiler.py, beside its own
# extractor (matching PerplexityRiskClassifier/HallucinationRiskClassifier,
# which already live beside theirs). Re-exported here so any existing
# `from forensic_reports import ReasoningRiskClassifier` keeps working.
from reasoning_profiler import ReasoningRiskClassifier  # noqa: F401
